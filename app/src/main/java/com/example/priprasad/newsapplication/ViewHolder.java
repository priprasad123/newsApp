...
import com.example.priprasad.newsapplication.ListNewsViewHolder;
import com.example.priprasad.newsapplication.MainActivity;
...
public class ViewHolder extends BaseAdapter {
    ...
    public ViewHolder(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    }
    public int getCount() {
